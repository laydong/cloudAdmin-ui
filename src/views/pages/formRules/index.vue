...
// 引入组件
const FormRulesOne = defineAsyncComponent(() => import('/src/views/pages/formRules/component/formRulesOne.vue'));
const FormRulesTwo = defineAsyncComponent(() => import('/src/views/pages/formRules/component/formRulesTwo.vue'));
const FormRulesThree = defineAsyncComponent(() => import('/src/views/pages/formRules/component/formRulesThree.vue'));
