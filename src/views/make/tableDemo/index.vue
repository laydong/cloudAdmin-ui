...
// 引入组件
const Table = defineAsyncComponent(() => import('/src/components/table/index.vue'));
const TableSearch = defineAsyncComponent(() => import('/src/views/make/tableDemo/search.vue'));
