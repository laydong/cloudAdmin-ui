...
// 引入组件
const Account = defineAsyncComponent(() => import('/src/views/login/component/account.vue'));
// const Mobile = defineAsyncComponent(() => import('/@/views/login/component/mobile.vue'));
const Scan = defineAsyncComponent(() => import('/src/views/login/component/scan.vue'));
