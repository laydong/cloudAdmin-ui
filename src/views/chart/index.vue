...
import { skyList, dBtnList, chartData4List } from '/src/views/chart/chart';

// 引入组件
const ChartHead = defineAsyncComponent(() => import('/src/views/chart/head.vue'));
		...
		series: [
			{
				...
				data: [
					{ name: 'cloud-admin', value: 520 },
					{ name: 'cloud', value: 520 },
