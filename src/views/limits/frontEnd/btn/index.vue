...
// 引入组件
const LimitsFrontEndPage = defineAsyncComponent(() => import('/src/views/limits/frontEnd/page/index.vue'));
const Auth = defineAsyncComponent(() => import('/src/components/auth/auth.vue'));
const Auths = defineAsyncComponent(() => import('/src/components/auth/auths.vue'));
const AuthAll = defineAsyncComponent(() => import('/src/components/auth/authAll.vue'));
