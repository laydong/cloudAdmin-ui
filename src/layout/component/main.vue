...
// 引入组件
const LayoutParentView = defineAsyncComponent(() => import('/src/layout/routerView/parent.vue'));
const LayoutFooter = defineAsyncComponent(() => import('/src/layout/footer/index.vue'));
