...
// 引入组件
const Breadcrumb = defineAsyncComponent(() => import('/src/layout/navBars/breadcrumb/breadcrumb.vue'));
const User = defineAsyncComponent(() => import('/src/layout/navBars/breadcrumb/user.vue'));
const Logo = defineAsyncComponent(() => import('/src/layout/logo/index.vue'));
const Horizontal = defineAsyncComponent(() => import('/src/layout/navMenu/horizontal.vue'));
